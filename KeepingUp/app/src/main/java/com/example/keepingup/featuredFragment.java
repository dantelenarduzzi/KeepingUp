...
public class featuredFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_featured2, container, false);
        if (mParam1 != null && mParam2 != null ){
            TextView text = view.findViewById(R.id.featuredText);
            TextView text2 = view.findViewById(R.id.featuredtext2);
